...
{
  std::transform(s, s + MyStringLen(s), s, [](char ch){ return std::toupper<char>(ch, std::locale("")); });
  return s;
}
#else
...
{
  std::transform(s, s + MyStringLen(s), s, [](wchar_t ch){ return std::toupper<wchar_t>(ch, std::locale("")); });
  return s;
}
#else
...
{
  std::transform(s, s + MyStringLen(s), s, [](char ch){ return std::tolower<char>(ch, std::locale("")); });
  return s;
}
#else
...
{
  std::transform(s, s + MyStringLen(s), s, [](wchar_t ch){ return std::tolower<wchar_t>(ch, std::locale("")); });
  return s;
}
#else
