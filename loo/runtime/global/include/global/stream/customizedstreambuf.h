...
#ifndef _LOO_GLOBAL_CUSTOMIZEDSTREAMBUF_HPP
#define _LOO_GLOBAL_CUSTOMIZEDSTREAMBUF_HPP
...
namespace loo
{
	class MemInputStreamBuf : public std::streambuf, noncopyable
	{
	public:
	...
	class CallbackOutputStreamBuf : public std::streambuf, noncopyable
	{
	public:
	...
	class VectorStreamCallback : noncopyable
	{
	public:
	...
	class StringStreamCallback : noncopyable
	{
	public:
