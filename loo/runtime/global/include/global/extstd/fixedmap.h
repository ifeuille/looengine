...
namespace loo
{
	...
	*/
	...
	{
		using BinarySearch = _hidden_::RecursiveBinarySearch< K, V, Index_t, S >;
...
{
	template <typename Key, typename Value, size_t ArraySize>
	struct hash< loo::FixedMap<Key, Value, ArraySize> >
	{
		ND_ size_t  operator () (const loo::FixedMap<Key, Value, ArraySize> &value) const
		{
