...
namespace loo
{
	...
	public:
		...
		using View_t = nonstd::basic_string_view< CharT >;
	...
	public:
		...
		void resize (size_t newSize)
		{
			...
			newSize = std::min (newSize, capacity () - 1);
...
namespace std
{
	...
	template <typename CharT, size_t StringSize>
	struct hash< loo::TStaticString< CharT, StringSize > >
	{
		ND_ size_t  operator () (const loo::TStaticString<CharT, StringSize> &value) const
		{
			return hash< nonstd::basic_string_view<CharT> > ()(value);
		}
	};
