...
namespace loo
{
	...
	public:
		...
		ND_ LOO_ALLOCATOR void*  Alloc (const BytesU size, const BytesU align)
		{
		...
		template <typename T>
		ND_ LOO_ALLOCATOR T*  Alloc (size_t count = 1)
		{
	...
	public:
		...
		ND_ LOO_ALLOCATOR void*  Allocate (BytesU size, BytesU align)
		{
	...
	public:
		...
		ND_ LOO_ALLOCATOR T*  allocate (const size_t count)
		{
