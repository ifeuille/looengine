...
#ifdef LOO_STD_BARRIER
#	define LOO_BARRIER_MODE	3
#elif defined(WINDOWS_TARGET_VERSION) and (WINDOWS_TARGET_VERSION >= 8)
#	define LOO_BARRIER_MODE	0
#else
#	define LOO_BARRIER_MODE	2
#endif
...
namespace loo
{
	...
	struct alignas(LOO_CACHE_LINE) Barrier
	{
		// types
	private:
		struct Bitfield {
...
namespace loo
{
	...
	public:
		...
		void wait ()
		{
			loo::global::MutextUniqueLock	lock(_mutex);
...
#  elif LOO_BARRIER_MODE == 1
#	pragma detect_mismatch( "LOO_BARRIER_MODE", "1" )
#  elif LOO_BARRIER_MODE == 2
#	pragma detect_mismatch( "LOO_BARRIER_MODE", "2" )
#  elif LOO_BARRIER_MODE == 3
#	pragma detect_mismatch( "LOO_BARRIER_MODE", "3" )
#  else
#	error fix me!
#  endif
