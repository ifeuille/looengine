...
constexpr inline uint64_t clz(uint64_t x) noexcept {
    x |= (x >> 1);
    x |= (x >> 2);
    x |= (x >> 4);
    x |= (x >> 8);
...
constexpr inline unsigned long clz (unsigned long x) noexcept {
	x |= (x >> 1);
	x |= (x >> 2);
	x |= (x >> 4);
	x |= (x >> 8);
...
constexpr inline uint32_t clz (uint32_t x) noexcept {
	x |= (x >> 1);
	x |= (x >> 2);
	x |= (x >> 4);
	x |= (x >> 8);
	x |= (x >> 16);
	return (sizeof (uint32_t) * CHAR_BIT) - details::popcount (x);
}
template<typename T>
...
constexpr UTILS_PUBLIC UTILS_PURE
unsigned int inline clz(unsigned int x) noexcept {
...
constexpr UTILS_PUBLIC UTILS_PURE
unsigned long inline clz(unsigned long x) noexcept {
...
constexpr UTILS_PUBLIC UTILS_PURE
unsigned long long inline clz(unsigned long long x) noexcept {
...
constexpr UTILS_PUBLIC UTILS_PURE
unsigned int inline ctz(unsigned int x) noexcept {
...
constexpr UTILS_PUBLIC UTILS_PURE
unsigned long inline ctz(unsigned long x) noexcept {
...
constexpr UTILS_PUBLIC UTILS_PURE
unsigned long long inline ctz(unsigned long long x) noexcept {
...
constexpr UTILS_PUBLIC UTILS_PURE
unsigned int inline popcount(unsigned int x) noexcept {
...
constexpr UTILS_PUBLIC UTILS_PURE
unsigned long inline popcount(unsigned long x) noexcept {
...
constexpr UTILS_PUBLIC UTILS_PURE
unsigned long long inline popcount(unsigned long long x) noexcept {
...
constexpr UTILS_PUBLIC UTILS_PURE
uint8_t inline popcount(uint8_t x) noexcept {
