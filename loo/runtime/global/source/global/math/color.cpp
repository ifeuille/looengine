...
namespace loo
{
	namespace math
	{
		...
		*/
		...
		FLinearColor::FLinearColor ( const vec3& Vector ) :
			R ( Vector.x ),
			G ( Vector.y ),
			B ( Vector.z ),
			A ( 1.0f )
		...
		FLinearColor::FLinearColor ( const vec4& Vector ) :
			R ( Vector.x ),
			G ( Vector.y ),
			B ( Vector.z ),
			A ( Vector.w )
		...
		*/
		...
		{
			0.f, 5.07705190066176E-06f, 2.33280046660989E-05f, 5.69217657121931E-05f, 0.000107187362341244f, 0.000175123977503027f, 0.000261543754548491f, 0.000367136269815943f, 0.000492503787191433f,
