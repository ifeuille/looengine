...
#define TrackBufferViewRemove(v)
	...
	LOO_FORCEINLINE VkResult  vkCreateInstance (const VkInstanceCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkInstance* Instance)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyInstance (VkInstance Instance, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkEnumeratePhysicalDevices (VkInstance Instance, uint32* PhysicalDeviceCount, VkPhysicalDevice* PhysicalDevices)
	{
	...
	static LOO_FORCEINLINE void  vkGetPhysicalDeviceFeatures (VkPhysicalDevice PhysicalDevice, VkPhysicalDeviceFeatures* Features)
	{
	...
	static LOO_FORCEINLINE void  vkGetPhysicalDeviceFormatProperties (VkPhysicalDevice PhysicalDevice, VkFormat Format, VkFormatProperties* FormatProperties)
	{
...
#if 0
	static LOO_FORCEINLINE VkResult  vkGetPhysicalDeviceImageFormatProperties (
...
#endif
	static LOO_FORCEINLINE void  vkGetPhysicalDeviceProperties (VkPhysicalDevice PhysicalDevice, VkPhysicalDeviceProperties* Properties)
	{
	...
	static LOO_FORCEINLINE void  vkGetPhysicalDeviceProperties2KHR (VkPhysicalDevice PhysicalDevice, VkPhysicalDeviceProperties2KHR* Properties)
	{
	...
	static LOO_FORCEINLINE void  vkGetPhysicalDeviceQueueFamilyProperties (VkPhysicalDevice PhysicalDevice, uint32* QueueFamilyPropertyCount, VkQueueFamilyProperties* QueueFamilyProperties)
	{
	...
	static LOO_FORCEINLINE void  vkGetPhysicalDeviceMemoryProperties (VkPhysicalDevice PhysicalDevice, VkPhysicalDeviceMemoryProperties* MemoryProperties)
	{
	...
	static LOO_FORCEINLINE PFN_vkVoidFunction  vkGetInstanceProcAddr (VkInstance Instance, const char* Name)
	{
	...
	static LOO_FORCEINLINE PFN_vkVoidFunction  vkGetDeviceProcAddr (VkDevice Device, const char* Name)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateDevice (VkPhysicalDevice PhysicalDevice, const VkDeviceCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkDevice* Device)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyDevice (VkDevice Device, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkEnumerateInstanceExtensionProperties (const char* LayerName, uint32* PropertyCount, VkExtensionProperties* Properties)
	{
	...
	static LOO_FORCEINLINE VkResult  vkEnumerateDeviceExtensionProperties (VkPhysicalDevice PhysicalDevice, const char* LayerName, uint32* PropertyCount, VkExtensionProperties* Properties)
	{
	...
	static LOO_FORCEINLINE VkResult  vkEnumerateInstanceLayerProperties (uint32* PropertyCount, VkLayerProperties* Properties)
	{
	...
	static LOO_FORCEINLINE VkResult  vkEnumerateDeviceLayerProperties (VkPhysicalDevice PhysicalDevice, uint32* PropertyCount, VkLayerProperties* Properties)
	{
	...
	static LOO_FORCEINLINE void  vkGetDeviceQueue (VkDevice Device, uint32 QueueFamilyIndex, uint32 QueueIndex, VkQueue* Queue)
	{
	...
	static LOO_FORCEINLINE VkResult  vkQueueSubmit (VkQueue Queue, uint32 SubmitCount, const VkSubmitInfo* Submits, VkFence Fence)
	{
	...
	static LOO_FORCEINLINE VkResult  vkQueueWaitIdle (VkQueue Queue)
	{
	...
	static LOO_FORCEINLINE VkResult  vkDeviceWaitIdle (VkDevice Device)
	{
	...
	static LOO_FORCEINLINE VkResult  vkAllocateMemory (VkDevice Device, const VkMemoryAllocateInfo* AllocateInfo, const VkAllocationCallbacks* Allocator, VkDeviceMemory* Memory)
	{
	...
	static LOO_FORCEINLINE void  vkFreeMemory (VkDevice Device, VkDeviceMemory Memory, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkMapMemory (VkDevice Device, VkDeviceMemory Memory, VkDeviceSize Offset, VkDeviceSize Size, VkMemoryMapFlags Flags, void** Data)
	{
	...
	static LOO_FORCEINLINE void  vkUnmapMemory (VkDevice Device, VkDeviceMemory Memory)
	{
		DevicePrintfBegin (Device, FString::Printf (TEXT ("vkUnmapMemory(DevMem=%p)"), Memory));
		VULKANAPINAMESPACE::vkUnmapMemory (Device, Memory);
	}

	static LOO_FORCEINLINE VkResult  vkFlushMappedMemoryRanges (VkDevice Device, uint32 MemoryRangeCount, const VkMappedMemoryRange* MemoryRanges)
	{
	...
	static LOO_FORCEINLINE VkResult  vkInvalidateMappedMemoryRanges (VkDevice Device, uint32 MemoryRangeCount, const VkMappedMemoryRange* MemoryRanges)
	{
		DumpMappedMemoryRanges (MemoryRangeCount, MemoryRanges);
...
#if 0
	static LOO_FORCEINLINE void  vkGetDeviceMemoryCommitment (
		VkDevice                                    Device,
		VkDeviceMemory                              Memory,
		VkDeviceSize*                               pCommittedMemoryInBytes);
#endif
	static LOO_FORCEINLINE VkResult  vkBindBufferMemory (VkDevice Device, VkBuffer Buffer, VkDeviceMemory Memory, VkDeviceSize MemoryOffset)
	{
	...
	static LOO_FORCEINLINE VkResult  vkBindImageMemory (VkDevice Device, VkImage Image, VkDeviceMemory Memory, VkDeviceSize MemoryOffset)
	{
	...
	static LOO_FORCEINLINE void  vkGetBufferMemoryRequirements (VkDevice Device, VkBuffer Buffer, VkMemoryRequirements* MemoryRequirements)
	{
	...
	static LOO_FORCEINLINE void  vkGetImageMemoryRequirements (VkDevice Device, VkImage Image, VkMemoryRequirements* MemoryRequirements)
	{
...
#if 0
	static LOO_FORCEINLINE void  vkGetImageSparseMemoryRequirements (
		VkDevice                                    Device,
		VkImage                                     Image,
		uint32*                                   pSparseMemoryRequirementCount,
		VkSparseImageMemoryRequirements*            pSparseMemoryRequirements);

	static LOO_FORCEINLINE void  vkGetPhysicalDeviceSparseImageFormatProperties (
		VkPhysicalDevice                            physicalDevice,
		VkFormat                                    format,
		VkImageType                                 type,
	...
	static LOO_FORCEINLINE VkResult  vkQueueBindSparse (
		VkQueue                                     queue,
		uint32                                    bindInfoCount,
		const VkBindSparseInfo*                     pBindInfo,
		VkFence                                     Fence);
#endif
	static LOO_FORCEINLINE VkResult  vkCreateFence (VkDevice Device, const VkFenceCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkFence* Fence)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyFence (VkDevice Device, VkFence Fence, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkResetFences (VkDevice Device, uint32 FenceCount, const VkFence* Fences)
	{
	...
	static LOO_FORCEINLINE VkResult  vkGetFenceStatus (VkDevice Device, VkFence Fence)
	{
	...
	static LOO_FORCEINLINE VkResult  vkWaitForFences (VkDevice Device, uint32 FenceCount, const VkFence* Fences, VkBool32 bWaitAll, uint64_t Timeout)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateSemaphore (VkDevice Device, const VkSemaphoreCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkSemaphore* Semaphore)
	{
	...
	static LOO_FORCEINLINE void  vkDestroySemaphore (VkDevice Device, VkSemaphore Semaphore, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateEvent (VkDevice Device, const VkEventCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkEvent* Event)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyEvent (VkDevice Device, VkEvent Event, const VkAllocationCallbacks* Allocator)
	{
...
#if 0
	static LOO_FORCEINLINE VkResult  vkGetEventStatus (
		VkDevice                                    Device,
		VkEvent                                     event);

	static LOO_FORCEINLINE VkResult  vkSetEvent (
		VkDevice                                    Device,
		VkEvent                                     event);

	static LOO_FORCEINLINE VkResult  vkResetEvent (
		VkDevice                                    Device,
		VkEvent                                     event);
#endif
	static LOO_FORCEINLINE VkResult  vkCreateQueryPool (VkDevice Device, const VkQueryPoolCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkQueryPool* QueryPool)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyQueryPool (VkDevice Device, VkQueryPool QueryPool, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkGetQueryPoolResults (VkDevice Device, VkQueryPool QueryPool,
	...
	static LOO_FORCEINLINE VkResult  vkCreateBuffer (VkDevice Device, const VkBufferCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkBuffer* Buffer)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyBuffer (VkDevice Device, VkBuffer Buffer, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateBufferView (VkDevice Device, const VkBufferViewCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkBufferView* View)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyBufferView (VkDevice Device, VkBufferView BufferView, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateImage (VkDevice Device, const VkImageCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkImage* Image)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyImage (VkDevice Device, VkImage Image, const VkAllocationCallbacks* Allocator)
	{
		DumpDestroyImage (Device, Image);
		VULKANAPINAMESPACE::vkDestroyImage (Device, Image, Allocator);
	}

	static LOO_FORCEINLINE void  vkGetImageSubresourceLayout (VkDevice Device, VkImage Image, const VkImageSubresource* Subresource, VkSubresourceLayout* Layout)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateImageView (VkDevice Device, const VkImageViewCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkImageView* View)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyImageView (VkDevice Device, VkImageView ImageView, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateShaderModule (VkDevice Device, const VkShaderModuleCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkShaderModule* ShaderModule)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyShaderModule (VkDevice Device, VkShaderModule ShaderModule, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreatePipelineCache (VkDevice Device, const VkPipelineCacheCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkPipelineCache* PipelineCache)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyPipelineCache (VkDevice Device, VkPipelineCache PipelineCache, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkGetPipelineCacheData (
		VkDevice                                    Device,
	...
	static LOO_FORCEINLINE VkResult  vkMergePipelineCaches (
		VkDevice                                    Device,
	...
	static LOO_FORCEINLINE VkResult  vkCreateGraphicsPipelines (VkDevice Device, VkPipelineCache PipelineCache, uint32 CreateInfoCount, const VkGraphicsPipelineCreateInfo* CreateInfos, const VkAllocationCallbacks* Allocator, VkPipeline* Pipelines)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateComputePipelines (VkDevice Device, VkPipelineCache PipelineCache, uint32 CreateInfoCount, const VkComputePipelineCreateInfo* CreateInfos, const VkAllocationCallbacks* Allocator, VkPipeline* Pipelines)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyPipeline (VkDevice Device, VkPipeline Pipeline, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreatePipelineLayout (VkDevice Device, const VkPipelineLayoutCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkPipelineLayout* PipelineLayout)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyPipelineLayout (VkDevice Device, VkPipelineLayout PipelineLayout, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateSampler (VkDevice Device, const VkSamplerCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkSampler* Sampler)
	{
	...
	static LOO_FORCEINLINE void  vkDestroySampler (VkDevice Device, VkSampler Sampler, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateDescriptorSetLayout (VkDevice Device, const VkDescriptorSetLayoutCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkDescriptorSetLayout* SetLayout)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyDescriptorSetLayout (VkDevice Device, VkDescriptorSetLayout DescriptorSetLayout, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateDescriptorPool (VkDevice Device, const VkDescriptorPoolCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkDescriptorPool* DescriptorPool)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyDescriptorPool (VkDevice Device, VkDescriptorPool DescriptorPool, const VkAllocationCallbacks* Allocator)
	{
...
#if 0
	static LOO_FORCEINLINE VkResult  vkResetDescriptorPool (
		VkDevice                                    Device,
		VkDescriptorPool                            descriptorPool,
		VkDescriptorPoolResetFlags                  flags);
#endif
	static LOO_FORCEINLINE VkResult  vkAllocateDescriptorSets (VkDevice Device, const VkDescriptorSetAllocateInfo* AllocateInfo, VkDescriptorSet* DescriptorSets)
	{
	...
	static LOO_FORCEINLINE VkResult  vkFreeDescriptorSets (VkDevice Device, VkDescriptorPool DescriptorPool, uint32 DescriptorSetCount, const VkDescriptorSet* DescriptorSets)
	{
	...
	static LOO_FORCEINLINE void  vkUpdateDescriptorSets (VkDevice Device, uint32 DescriptorWriteCount, const VkWriteDescriptorSet* DescriptorWrites, uint32 DescriptorCopyCount, const VkCopyDescriptorSet* DescriptorCopies)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateFramebuffer (VkDevice Device, const VkFramebufferCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkFramebuffer* Framebuffer)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyFramebuffer (VkDevice Device, VkFramebuffer Framebuffer, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult  vkCreateRenderPass (VkDevice Device, const VkRenderPassCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkRenderPass* RenderPass)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyRenderPass (VkDevice Device, VkRenderPass RenderPass, const VkAllocationCallbacks* Allocator)
	{
...
#if 0
	static LOO_FORCEINLINE void  vkGetRenderAreaGranularity (
		VkDevice                                    Device,
		VkRenderPass                                renderPass,
		VkExtent2D*                                 pGranularity);
#endif
	static LOO_FORCEINLINE VkResult  vkCreateCommandPool (VkDevice Device, const VkCommandPoolCreateInfo* CreateInfo, const VkAllocationCallbacks* Allocator, VkCommandPool* CommandPool)
	{
	...
	static LOO_FORCEINLINE void  vkDestroyCommandPool (VkDevice Device, VkCommandPool CommandPool, const VkAllocationCallbacks* Allocator)
	{
...
#if 0
	static LOO_FORCEINLINE VkResult  vkResetCommandPool (
		VkDevice                                    Device,
		VkCommandPool                               commandPool,
		VkCommandPoolResetFlags                     flags);
#endif
	static LOO_FORCEINLINE VkResult  vkAllocateCommandBuffers (VkDevice Device, const VkCommandBufferAllocateInfo* AllocateInfo, VkCommandBuffer* CommandBuffers)
	{
	...
	static LOO_FORCEINLINE void  vkFreeCommandBuffers (VkDevice Device, VkCommandPool CommandPool, uint32 CommandBufferCount, const VkCommandBuffer* CommandBuffers)
	{
	...
	static LOO_FORCEINLINE VkResult  vkBeginCommandBuffer (VkCommandBuffer CommandBuffer, const VkCommandBufferBeginInfo* BeginInfo)
	{
	...
	static LOO_FORCEINLINE VkResult  vkEndCommandBuffer (VkCommandBuffer CommandBuffer)
	{
	...
	static LOO_FORCEINLINE VkResult  vkResetCommandBuffer (VkCommandBuffer CommandBuffer, VkCommandBufferResetFlags Flags)
	{
	...
	static LOO_FORCEINLINE void  vkCmdBindPipeline (VkCommandBuffer CommandBuffer, VkPipelineBindPoint PipelineBindPoint, VkPipeline Pipeline)
	{
	...
	static LOO_FORCEINLINE void  vkCmdSetViewport (VkCommandBuffer CommandBuffer, uint32 FirstViewport, uint32 ViewportCount, const VkViewport* Viewports)
	{
	...
	static LOO_FORCEINLINE void  vkCmdSetScissor (VkCommandBuffer CommandBuffer, uint32 FirstScissor, uint32 ScissorCount, const VkRect2D* Scissors)
	{
	...
	static LOO_FORCEINLINE void  vkCmdSetLineWidth (VkCommandBuffer CommandBuffer, float LineWidth)
	{
...
#if 0
	static LOO_FORCEINLINE void  vkCmdSetDepthBias (
		VkCommandBuffer                             commandBuffer,
		float                                       depthBiasConstantFactor,
		float                                       depthBiasClamp,
		float                                       depthBiasSlopeFactor);

	static LOO_FORCEINLINE void  vkCmdSetBlendConstants (
		VkCommandBuffer                             commandBuffer,
		const float                                 blendConstants[4]);

	static LOO_FORCEINLINE void  vkCmdSetDepthBounds (
		VkCommandBuffer                             commandBuffer,
		float                                       minDepthBounds,
		float                                       maxDepthBounds);

	static LOO_FORCEINLINE void  vkCmdSetStencilCompareMask (
		VkCommandBuffer                             commandBuffer,
		VkStencilFaceFlags                          faceMask,
		uint32                                    compareMask);

	static LOO_FORCEINLINE void  vkCmdSetStencilWriteMask (
		VkCommandBuffer                             commandBuffer,
		VkStencilFaceFlags                          faceMask,
		uint32                                    writeMask);

#endif
	static LOO_FORCEINLINE void  vkCmdSetStencilReference (VkCommandBuffer CommandBuffer, VkStencilFaceFlags FaceMask, uint32 Reference)
	{
	...
	static LOO_FORCEINLINE void  vkCmdBindDescriptorSets (VkCommandBuffer CommandBuffer, VkPipelineBindPoint PipelineBindPoint, VkPipelineLayout Layout, uint32 FirstSet, uint32 DescriptorSetCount, const VkDescriptorSet* DescriptorSets, uint32 DynamicOffsetCount, const uint32* DynamicOffsets)
	{
	...
	static LOO_FORCEINLINE void  vkCmdBindIndexBuffer (VkCommandBuffer CommandBuffer, VkBuffer Buffer, VkDeviceSize Offset, VkIndexType IndexType)
	{
	...
	static LOO_FORCEINLINE void  vkCmdBindVertexBuffers (VkCommandBuffer CommandBuffer, uint32 FirstBinding, uint32 BindingCount, const VkBuffer* Buffers, const VkDeviceSize* Offsets)
	{
	...
	static LOO_FORCEINLINE void  vkCmdDraw (VkCommandBuffer CommandBuffer, uint32 VertexCount, uint32 InstanceCount, uint32 FirstVertex, uint32 FirstInstance)
	{
	...
	static LOO_FORCEINLINE void  vkCmdDrawIndexed (VkCommandBuffer CommandBuffer, uint32 IndexCount, uint32 InstanceCount, uint32 FirstIndex, int32_t VertexOffset, uint32 FirstInstance)
	{
	...
	static LOO_FORCEINLINE void  vkCmdDrawIndirect (VkCommandBuffer CommandBuffer, VkBuffer Buffer, VkDeviceSize Offset, uint32 DrawCount, uint32 Stride)
	{
	...
	static LOO_FORCEINLINE void  vkCmdDrawIndexedIndirect (VkCommandBuffer CommandBuffer, VkBuffer Buffer, VkDeviceSize Offset, uint32 DrawCount, uint32 Stride)
	{
	...
	static LOO_FORCEINLINE void  vkCmdDispatch (VkCommandBuffer CommandBuffer, uint32 X, uint32 Y, uint32 Z)
	{
	...
	static LOO_FORCEINLINE void  vkCmdDispatchIndirect (VkCommandBuffer CommandBuffer, VkBuffer Buffer, VkDeviceSize Offset)
	{
	...
	static LOO_FORCEINLINE void  vkCmdCopyBuffer (VkCommandBuffer CommandBuffer, VkBuffer SrcBuffer, VkBuffer DstBuffer, uint32 RegionCount, const VkBufferCopy* Regions)
	{
	...
	static LOO_FORCEINLINE void  vkCmdCopyImage (VkCommandBuffer CommandBuffer, VkImage SrcImage, VkImageLayout SrcImageLayout, VkImage DstImage, VkImageLayout DstImageLayout, uint32 RegionCount, const VkImageCopy* Regions)
	{
	...
	static LOO_FORCEINLINE void  vkCmdBlitImage (VkCommandBuffer CommandBuffer, VkImage SrcImage, VkImageLayout SrcImageLayout, VkImage DstImage, VkImageLayout DstImageLayout, uint32 RegionCount, const VkImageBlit* Regions, VkFilter Filter)
	{
	...
	static LOO_FORCEINLINE void  vkCmdCopyBufferToImage (VkCommandBuffer CommandBuffer, VkBuffer SrcBuffer, VkImage DstImage, VkImageLayout DstImageLayout, uint32 RegionCount, const VkBufferImageCopy* Regions)
	{
	...
	static LOO_FORCEINLINE void  vkCmdCopyImageToBuffer (VkCommandBuffer CommandBuffer, VkImage SrcImage, VkImageLayout SrcImageLayout, VkBuffer DstBuffer, uint32 RegionCount, const VkBufferImageCopy* Regions)
	{
...
#if 0
	static LOO_FORCEINLINE void  vkCmdUpdateBuffer (
		VkCommandBuffer                             commandBuffer,
		VkBuffer                                    dstBuffer,
	...
	static LOO_FORCEINLINE void  vkCmdFillBuffer (VkCommandBuffer CommandBuffer, VkBuffer DstBuffer, VkDeviceSize DstOffset, VkDeviceSize Size, uint32 Data)
	{
	...
	static LOO_FORCEINLINE void  vkCmdClearColorImage (VkCommandBuffer CommandBuffer, VkImage Image, VkImageLayout ImageLayout, const VkClearColorValue* Color, uint32 RangeCount, const VkImageSubresourceRange* Ranges)
	{
	...
	static LOO_FORCEINLINE void  vkCmdClearDepthStencilImage (VkCommandBuffer CommandBuffer, VkImage Image, VkImageLayout ImageLayout, const VkClearDepthStencilValue* DepthStencil, uint32 RangeCount, const VkImageSubresourceRange* Ranges)
	{
	...
	static LOO_FORCEINLINE void  vkCmdClearAttachments (VkCommandBuffer CommandBuffer, uint32 AttachmentCount, const VkClearAttachment* Attachments, uint32 RectCount, const VkClearRect* Rects)
	{
	...
	static LOO_FORCEINLINE void  vkCmdResolveImage (
		VkCommandBuffer CommandBuffer,
	...
	static LOO_FORCEINLINE void  vkCmdSetEvent (VkCommandBuffer CommandBuffer, VkEvent Event, VkPipelineStageFlags StageMask)
	{
	...
	static LOO_FORCEINLINE void  vkCmdResetEvent (VkCommandBuffer CommandBuffer, VkEvent Event, VkPipelineStageFlags StageMask)
	{
	...
	static LOO_FORCEINLINE void  vkCmdWaitEvents (VkCommandBuffer CommandBuffer, uint32 EventCount, const VkEvent* Events,
	...
	static LOO_FORCEINLINE void  vkCmdPipelineBarrier (
...
#if 0
	static LOO_FORCEINLINE void  vkCmdBeginQuery (
		VkCommandBuffer                             commandBuffer,
		VkQueryPool                                 queryPool,
		uint32                                    query,
		VkQueryControlFlags                         flags);

	static LOO_FORCEINLINE void  vkCmdEndQuery (
		VkCommandBuffer                             commandBuffer,
		VkQueryPool                                 queryPool,
		uint32                                    query);
#endif
	static LOO_FORCEINLINE void  vkCmdResetQueryPool (VkCommandBuffer CommandBuffer, VkQueryPool QueryPool, uint32 FirstQuery, uint32 QueryCount)
	{
	...
	static LOO_FORCEINLINE void  vkCmdWriteTimestamp (VkCommandBuffer CommandBuffer, VkPipelineStageFlagBits PipelineStage, VkQueryPool QueryPool, uint32 Query)
	{
	...
	static LOO_FORCEINLINE void  vkCmdCopyQueryPoolResults (VkCommandBuffer CommandBuffer, VkQueryPool QueryPool, uint32 FirstQuery, uint32 QueryCount,
...
#if 0
	static LOO_FORCEINLINE void  vkCmdPushConstants (
		VkCommandBuffer                             commandBuffer,
		...
		const void*                                 pValues);
#endif
	static LOO_FORCEINLINE void  vkCmdBeginRenderPass (
		VkCommandBuffer CommandBuffer,
...
#if 0
	static LOO_FORCEINLINE void  vkCmdNextSubpass (
		VkCommandBuffer                             commandBuffer,
		VkSubpassContents                           contents);
#endif
	static LOO_FORCEINLINE void  vkCmdEndRenderPass (VkCommandBuffer CommandBuffer)
	{
...
#if 0
	static LOO_FORCEINLINE void  vkCmdExecuteCommands (
		VkCommandBuffer                             commandBuffer,
		uint32                                    commandBufferCount,
		const VkCommandBuffer*                      pCommandBuffers);
#endif

	static LOO_FORCEINLINE VkResult vkCreateSwapchainKHR (VkDevice Device, const VkSwapchainCreateInfoKHR* CreateInfo, const VkAllocationCallbacks* Allocator, VkSwapchainKHR* Swapchain)
	{
	...
	static LOO_FORCEINLINE void vkDestroySwapchainKHR (VkDevice Device, VkSwapchainKHR Swapchain, const VkAllocationCallbacks* Allocator)
	{
	...
	static LOO_FORCEINLINE VkResult vkGetSwapchainImagesKHR (VkDevice Device, VkSwapchainKHR Swapchain, uint32_t* SwapchainImageCount, VkImage* SwapchainImages)
	{
	...
	static LOO_FORCEINLINE VkResult vkAcquireNextImageKHR (VkDevice Device, VkSwapchainKHR Swapchain, uint64_t Timeout, VkSemaphore Semaphore, VkFence Fence, uint32_t* ImageIndex)
	{
	...
	static LOO_FORCEINLINE VkResult vkQueuePresentKHR (VkQueue Queue, const VkPresentInfoKHR* PresentInfo)
	{
	...
	static LOO_FORCEINLINE VkResult vkGetPhysicalDeviceSurfaceCapabilitiesKHR (VkPhysicalDevice PhysicalDevice, VkSurfaceKHR Surface, VkSurfaceCapabilitiesKHR* SurfaceCapabilities)
	{
	...
	static LOO_FORCEINLINE VkResult vkGetPhysicalDeviceSurfaceFormatsKHR (VkPhysicalDevice PhysicalDevice, VkSurfaceKHR Surface, uint32_t* SurfaceFormatCountPtr, VkSurfaceFormatKHR* SurfaceFormats)
	{
	...
	static LOO_FORCEINLINE VkResult vkGetPhysicalDeviceSurfaceSupportKHR (VkPhysicalDevice PhysicalDevice, uint32_t QueueFamilyIndex, VkSurfaceKHR Surface, VkBool32* SupportedPtr)
	{
	...
	static LOO_FORCEINLINE VkResult vkGetPhysicalDeviceSurfacePresentModesKHR (VkPhysicalDevice PhysicalDevice, VkSurfaceKHR Surface, uint32_t* PresentModeCountPtr, VkPresentModeKHR* PresentModesPtr)
	{
	...
	static LOO_FORCEINLINE VkResult vkCreateWin32SurfaceKHR (VkInstance Instance, const VkWin32SurfaceCreateInfoKHR* CreateInfo, const VkAllocationCallbacks* Allocator, VkSurfaceKHR* Surface)
	{
		PrintfBeginResult (FString::Printf (TEXT ("vkCreateWin32SurfaceKHR(Instance=%p, CreateInfo=%p, Allocator=%p, Surface=%p)[...]"), Instance, CreateInfo, Allocator, Surface));
	...
	static LOO_FORCEINLINE VkResult vkCreateAndroidSurfaceKHR (VkInstance Instance, const VkAndroidSurfaceCreateInfoKHR* CreateInfo, const VkAllocationCallbacks* Allocator, VkSurfaceKHR* Surface)
	{
	...
	static LOO_FORCEINLINE void vkDestroySurfaceKHR (VkInstance Instance, VkSurfaceKHR Surface, const VkAllocationCallbacks* pAllocator)
	{
