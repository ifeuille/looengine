...
{
static detail::LooClassBuilder<loo::Object, 1, 2> reflected([](auto self) {
...
functionRet1.m_type = LooGetType<char>();
functionRet1.m_flags = 0/*TODO*/;
functionRet1.m_serializedWidth = sizeof(char) * 8;
functionRet1.m_qualifier = Qualifier(0, 0, 0, 1, 0, 0);
...
self->functions[1].m_parametersEnd = &functionParameters1[0];
self->functions[1].m_flags = LooFunction::kFlagsNull | LooFunction::kFlagsMember;
self->functions[1].m_name = "name";
});
...
const looreflect::LooType *loo::Object::GetType() const { return looreflect::LooGetClass<loo::Object>();}
