	...
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkEnumerateInstanceLayerProperties (uint32_t * , VkLayerProperties * )			{  LOO_LOGI( "used dummy function 'vkEnumerateInstanceLayerProperties'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL Dummy_vkGetInstanceProcAddr (VkInstance , const char * )			{  LOO_LOGI( "used dummy function 'vkGetInstanceProcAddr'" );  return null;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateInstance (const VkInstanceCreateInfo * , const VkAllocationCallbacks * , VkInstance * )			{  LOO_LOGI( "used dummy function 'vkCreateInstance'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkBool32 VKAPI_CALL Dummy_vkDebugUtilsMessengerCallbackEXT (VkDebugUtilsMessageSeverityFlagBitsEXT , VkDebugUtilsMessageTypeFlagsEXT , const VkDebugUtilsMessengerCallbackDataEXT * , void * )			{  LOO_LOGI( "used dummy function 'vkDebugUtilsMessengerCallbackEXT'" );  return VkBool32(0);  }
	VKAPI_ATTR VkBool32 VKAPI_CALL Dummy_vkDebugReportCallbackEXT (VkDebugReportFlagsEXT , VkDebugReportObjectTypeEXT , uint64_t , size_t , int32_t , const char * , const char * , void * )			{  LOO_LOGI( "used dummy function 'vkDebugReportCallbackEXT'" );  return VkBool32(0);  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkEnumerateInstanceVersion (uint32_t * )			{  LOO_LOGI( "used dummy function 'vkEnumerateInstanceVersion'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkEnumerateInstanceExtensionProperties (const char * , uint32_t * , VkExtensionProperties * )			{  LOO_LOGI( "used dummy function 'vkEnumerateInstanceExtensionProperties'" );  return VK_RESULT_MAX_ENUM;  }
