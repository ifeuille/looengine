...
# endif // VULKAN_WAYLAND_H_
	...
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateDevice (VkPhysicalDevice , const VkDeviceCreateInfo * , const VkAllocationCallbacks * , VkDevice * )			{  LOO_LOGI( "used dummy function 'vkCreateDevice'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateDisplayPlaneSurfaceKHR (VkInstance , const VkDisplaySurfaceCreateInfoKHR * , const VkAllocationCallbacks * , VkSurfaceKHR * )			{  LOO_LOGI( "used dummy function 'vkCreateDisplayPlaneSurfaceKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceExternalFencePropertiesKHR (VkPhysicalDevice , const VkPhysicalDeviceExternalFenceInfo * , VkExternalFenceProperties * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceExternalFencePropertiesKHR'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceImageFormatProperties2KHR (VkPhysicalDevice , const VkPhysicalDeviceImageFormatInfo2 * , VkImageFormatProperties2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceImageFormatProperties2KHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceMemoryProperties2KHR (VkPhysicalDevice , VkPhysicalDeviceMemoryProperties2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceMemoryProperties2KHR'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceQueueFamilyProperties (VkPhysicalDevice , uint32_t * , VkQueueFamilyProperties * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceQueueFamilyProperties'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateHeadlessSurfaceEXT (VkInstance , const VkHeadlessSurfaceCreateInfoEXT * , const VkAllocationCallbacks * , VkSurfaceKHR * )			{  LOO_LOGI( "used dummy function 'vkCreateHeadlessSurfaceEXT'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceDisplayProperties2KHR (VkPhysicalDevice , uint32_t * , VkDisplayProperties2KHR * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceDisplayProperties2KHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceSurfaceCapabilities2EXT (VkPhysicalDevice , VkSurfaceKHR , VkSurfaceCapabilities2EXT * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceSurfaceCapabilities2EXT'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetDisplayPlaneSupportedDisplaysKHR (VkPhysicalDevice , uint32_t , uint32_t * , VkDisplayKHR * )			{  LOO_LOGI( "used dummy function 'vkGetDisplayPlaneSupportedDisplaysKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetDisplayModePropertiesKHR (VkPhysicalDevice , VkDisplayKHR , uint32_t * , VkDisplayModePropertiesKHR * )			{  LOO_LOGI( "used dummy function 'vkGetDisplayModePropertiesKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceProperties2KHR (VkPhysicalDevice , VkPhysicalDeviceProperties2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceProperties2KHR'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceSurfaceFormats2KHR (VkPhysicalDevice , const VkPhysicalDeviceSurfaceInfo2KHR * , uint32_t * , VkSurfaceFormat2KHR * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceSurfaceFormats2KHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkDebugReportMessageEXT (VkInstance , VkDebugReportFlagsEXT , VkDebugReportObjectTypeEXT , uint64_t , size_t , int32_t , const char * , const char * )			{  LOO_LOGI( "used dummy function 'vkDebugReportMessageEXT'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX (VkPhysicalDevice , VkDeviceGeneratedCommandsFeaturesNVX * , VkDeviceGeneratedCommandsLimitsNVX * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetDisplayPlaneCapabilitiesKHR (VkPhysicalDevice , VkDisplayModeKHR , uint32_t , VkDisplayPlaneCapabilitiesKHR * )			{  LOO_LOGI( "used dummy function 'vkGetDisplayPlaneCapabilitiesKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceSurfaceSupportKHR (VkPhysicalDevice , uint32_t , VkSurfaceKHR , VkBool32 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceSurfaceSupportKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceDisplayPlaneProperties2KHR (VkPhysicalDevice , uint32_t * , VkDisplayPlaneProperties2KHR * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceDisplayPlaneProperties2KHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceExternalSemaphoreProperties (VkPhysicalDevice , const VkPhysicalDeviceExternalSemaphoreInfo * , VkExternalSemaphoreProperties * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceExternalSemaphoreProperties'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceQueueFamilyProperties2 (VkPhysicalDevice , uint32_t * , VkQueueFamilyProperties2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceQueueFamilyProperties2'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkDestroyDebugReportCallbackEXT (VkInstance , VkDebugReportCallbackEXT , const VkAllocationCallbacks * )			{  LOO_LOGI( "used dummy function 'vkDestroyDebugReportCallbackEXT'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetDisplayPlaneCapabilities2KHR (VkPhysicalDevice , const VkDisplayPlaneInfo2KHR * , VkDisplayPlaneCapabilities2KHR * )			{  LOO_LOGI( "used dummy function 'vkGetDisplayPlaneCapabilities2KHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceExternalFenceProperties (VkPhysicalDevice , const VkPhysicalDeviceExternalFenceInfo * , VkExternalFenceProperties * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceExternalFenceProperties'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateDebugUtilsMessengerEXT (VkInstance , const VkDebugUtilsMessengerCreateInfoEXT * , const VkAllocationCallbacks * , VkDebugUtilsMessengerEXT * )			{  LOO_LOGI( "used dummy function 'vkCreateDebugUtilsMessengerEXT'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceImageFormatProperties (VkPhysicalDevice , VkFormat , VkImageType , VkImageTiling , VkImageUsageFlags , VkImageCreateFlags , VkImageFormatProperties * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceImageFormatProperties'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkEnumerateDeviceExtensionProperties (VkPhysicalDevice , const char * , uint32_t * , VkExtensionProperties * )			{  LOO_LOGI( "used dummy function 'vkEnumerateDeviceExtensionProperties'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceExternalSemaphorePropertiesKHR (VkPhysicalDevice , const VkPhysicalDeviceExternalSemaphoreInfo * , VkExternalSemaphoreProperties * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceExternalSemaphorePropertiesKHR'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceSurfaceCapabilities2KHR (VkPhysicalDevice , const VkPhysicalDeviceSurfaceInfo2KHR * , VkSurfaceCapabilities2KHR * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceSurfaceCapabilities2KHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceMemoryProperties (VkPhysicalDevice , VkPhysicalDeviceMemoryProperties * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceMemoryProperties'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateDisplayModeKHR (VkPhysicalDevice , VkDisplayKHR , const VkDisplayModeCreateInfoKHR * , const VkAllocationCallbacks * , VkDisplayModeKHR * )			{  LOO_LOGI( "used dummy function 'vkCreateDisplayModeKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceFeatures (VkPhysicalDevice , VkPhysicalDeviceFeatures * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceFeatures'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceMemoryProperties2 (VkPhysicalDevice , VkPhysicalDeviceMemoryProperties2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceMemoryProperties2'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceProperties2 (VkPhysicalDevice , VkPhysicalDeviceProperties2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceProperties2'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceQueueFamilyProperties2KHR (VkPhysicalDevice , uint32_t * , VkQueueFamilyProperties2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceQueueFamilyProperties2KHR'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceProperties (VkPhysicalDevice , VkPhysicalDeviceProperties * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceProperties'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceFormatProperties (VkPhysicalDevice , VkFormat , VkFormatProperties * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceFormatProperties'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceSurfacePresentModesKHR (VkPhysicalDevice , VkSurfaceKHR , uint32_t * , VkPresentModeKHR * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceSurfacePresentModesKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkDestroyInstance (VkInstance , const VkAllocationCallbacks * )			{  LOO_LOGI( "used dummy function 'vkDestroyInstance'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceFeatures2KHR (VkPhysicalDevice , VkPhysicalDeviceFeatures2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceFeatures2KHR'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceDisplayPlanePropertiesKHR (VkPhysicalDevice , uint32_t * , VkDisplayPlanePropertiesKHR * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceDisplayPlanePropertiesKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceExternalImageFormatPropertiesNV (VkPhysicalDevice , VkFormat , VkImageType , VkImageTiling , VkImageUsageFlags , VkImageCreateFlags , VkExternalMemoryHandleTypeFlagsNV , VkExternalImageFormatPropertiesNV * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceExternalImageFormatPropertiesNV'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL Dummy_vkGetDeviceProcAddr (VkDevice , const char * )			{  LOO_LOGI( "used dummy function 'vkGetDeviceProcAddr'" );  return null;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceMultisamplePropertiesEXT (VkPhysicalDevice , VkSampleCountFlagBits , VkMultisamplePropertiesEXT * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceMultisamplePropertiesEXT'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceSurfaceCapabilitiesKHR (VkPhysicalDevice , VkSurfaceKHR , VkSurfaceCapabilitiesKHR * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceSurfaceCapabilitiesKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkEnumeratePhysicalDeviceGroups (VkInstance , uint32_t * , VkPhysicalDeviceGroupProperties * )			{  LOO_LOGI( "used dummy function 'vkEnumeratePhysicalDeviceGroups'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceSparseImageFormatProperties2KHR (VkPhysicalDevice , const VkPhysicalDeviceSparseImageFormatInfo2 * , uint32_t * , VkSparseImageFormatProperties2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceSparseImageFormatProperties2KHR'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkEnumeratePhysicalDevices (VkInstance , uint32_t * , VkPhysicalDevice * )			{  LOO_LOGI( "used dummy function 'vkEnumeratePhysicalDevices'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkEnumeratePhysicalDeviceGroupsKHR (VkInstance , uint32_t * , VkPhysicalDeviceGroupProperties * )			{  LOO_LOGI( "used dummy function 'vkEnumeratePhysicalDeviceGroupsKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceFormatProperties2KHR (VkPhysicalDevice , VkFormat , VkFormatProperties2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceFormatProperties2KHR'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceCalibrateableTimeDomainsEXT (VkPhysicalDevice , uint32_t * , VkTimeDomainEXT * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceCalibrateableTimeDomainsEXT'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetDisplayModeProperties2KHR (VkPhysicalDevice , VkDisplayKHR , uint32_t * , VkDisplayModeProperties2KHR * )			{  LOO_LOGI( "used dummy function 'vkGetDisplayModeProperties2KHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkDestroyDebugUtilsMessengerEXT (VkInstance , VkDebugUtilsMessengerEXT , const VkAllocationCallbacks * )			{  LOO_LOGI( "used dummy function 'vkDestroyDebugUtilsMessengerEXT'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceExternalBufferPropertiesKHR (VkPhysicalDevice , const VkPhysicalDeviceExternalBufferInfo * , VkExternalBufferProperties * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceExternalBufferPropertiesKHR'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV (VkPhysicalDevice , uint32_t * , VkCooperativeMatrixPropertiesNV * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceCooperativeMatrixPropertiesNV'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceImageFormatProperties2 (VkPhysicalDevice , const VkPhysicalDeviceImageFormatInfo2 * , VkImageFormatProperties2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceImageFormatProperties2'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceSparseImageFormatProperties (VkPhysicalDevice , VkFormat , VkImageType , VkSampleCountFlagBits , VkImageUsageFlags , VkImageTiling , uint32_t * , VkSparseImageFormatProperties * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceSparseImageFormatProperties'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV (VkPhysicalDevice , uint32_t * , VkFramebufferMixedSamplesCombinationNV * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDevicePresentRectanglesKHR (VkPhysicalDevice , VkSurfaceKHR , uint32_t * , VkRect2D * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDevicePresentRectanglesKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceFormatProperties2 (VkPhysicalDevice , VkFormat , VkFormatProperties2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceFormatProperties2'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceExternalBufferProperties (VkPhysicalDevice , const VkPhysicalDeviceExternalBufferInfo * , VkExternalBufferProperties * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceExternalBufferProperties'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkSubmitDebugUtilsMessageEXT (VkInstance , VkDebugUtilsMessageSeverityFlagBitsEXT , VkDebugUtilsMessageTypeFlagsEXT , const VkDebugUtilsMessengerCallbackDataEXT * )			{  LOO_LOGI( "used dummy function 'vkSubmitDebugUtilsMessageEXT'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateDebugReportCallbackEXT (VkInstance , const VkDebugReportCallbackCreateInfoEXT * , const VkAllocationCallbacks * , VkDebugReportCallbackEXT * )			{  LOO_LOGI( "used dummy function 'vkCreateDebugReportCallbackEXT'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkDestroySurfaceKHR (VkInstance , VkSurfaceKHR , const VkAllocationCallbacks * )			{  LOO_LOGI( "used dummy function 'vkDestroySurfaceKHR'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceDisplayPropertiesKHR (VkPhysicalDevice , uint32_t * , VkDisplayPropertiesKHR * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceDisplayPropertiesKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceSurfaceFormatsKHR (VkPhysicalDevice , VkSurfaceKHR , uint32_t * , VkSurfaceFormatKHR * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceSurfaceFormatsKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkReleaseDisplayEXT (VkPhysicalDevice , VkDisplayKHR )			{  LOO_LOGI( "used dummy function 'vkReleaseDisplayEXT'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceFeatures2 (VkPhysicalDevice , VkPhysicalDeviceFeatures2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceFeatures2'" );  return;  }
	VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceSparseImageFormatProperties2 (VkPhysicalDevice , const VkPhysicalDeviceSparseImageFormatInfo2 * , uint32_t * , VkSparseImageFormatProperties2 * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceSparseImageFormatProperties2'" );  return;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkEnumerateDeviceLayerProperties (VkPhysicalDevice , uint32_t * , VkLayerProperties * )			{  LOO_LOGI( "used dummy function 'vkEnumerateDeviceLayerProperties'" );  return VK_RESULT_MAX_ENUM;  }


# ifdef VULKAN_WIN32_H_
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateWin32SurfaceKHR (VkInstance , const VkWin32SurfaceCreateInfoKHR * , const VkAllocationCallbacks * , VkSurfaceKHR * )			{  LOO_LOGI( "used dummy function 'vkCreateWin32SurfaceKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkBool32 VKAPI_CALL Dummy_vkGetPhysicalDeviceWin32PresentationSupportKHR (VkPhysicalDevice , uint32_t )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceWin32PresentationSupportKHR'" );  return VkBool32(0);  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceSurfacePresentModes2EXT (VkPhysicalDevice , const VkPhysicalDeviceSurfaceInfo2KHR * , uint32_t * , VkPresentModeKHR * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceSurfacePresentModes2EXT'" );  return VK_RESULT_MAX_ENUM;  }
# endif // VULKAN_WIN32_H_


# ifdef VULKAN_ANDROID_H_
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateAndroidSurfaceKHR (VkInstance , const VkAndroidSurfaceCreateInfoKHR * , const VkAllocationCallbacks * , VkSurfaceKHR * )			{  LOO_LOGI( "used dummy function 'vkCreateAndroidSurfaceKHR'" );  return VK_RESULT_MAX_ENUM;  }
# endif // VULKAN_ANDROID_H_


# ifdef VULKAN_XLIB_H_
	VKAPI_ATTR VkBool32 VKAPI_CALL Dummy_vkGetPhysicalDeviceXlibPresentationSupportKHR (VkPhysicalDevice , uint32_t , Display * , VisualID )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceXlibPresentationSupportKHR'" );  return VkBool32(0);  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateXlibSurfaceKHR (VkInstance , const VkXlibSurfaceCreateInfoKHR * , const VkAllocationCallbacks * , VkSurfaceKHR * )			{  LOO_LOGI( "used dummy function 'vkCreateXlibSurfaceKHR'" );  return VK_RESULT_MAX_ENUM;  }
# endif // VULKAN_XLIB_H_


# ifdef VULKAN_XLIB_XRANDR_H_
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkAcquireXlibDisplayEXT (VkPhysicalDevice , Display * , VkDisplayKHR )			{  LOO_LOGI( "used dummy function 'vkAcquireXlibDisplayEXT'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetRandROutputDisplayEXT (VkPhysicalDevice , Display * , RROutput , VkDisplayKHR * )			{  LOO_LOGI( "used dummy function 'vkGetRandROutputDisplayEXT'" );  return VK_RESULT_MAX_ENUM;  }
# endif // VULKAN_XLIB_XRANDR_H_


# ifdef VULKAN_XCB_H_
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateXcbSurfaceKHR (VkInstance , const VkXcbSurfaceCreateInfoKHR * , const VkAllocationCallbacks * , VkSurfaceKHR * )			{  LOO_LOGI( "used dummy function 'vkCreateXcbSurfaceKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkBool32 VKAPI_CALL Dummy_vkGetPhysicalDeviceXcbPresentationSupportKHR (VkPhysicalDevice , uint32_t , xcb_connection_t * , xcb_visualid_t )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceXcbPresentationSupportKHR'" );  return VkBool32(0);  }
# endif // VULKAN_XCB_H_


# ifdef VULKAN_WAYLAND_H_
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateWaylandSurfaceKHR (VkInstance , const VkWaylandSurfaceCreateInfoKHR * , const VkAllocationCallbacks * , VkSurfaceKHR * )			{  LOO_LOGI( "used dummy function 'vkCreateWaylandSurfaceKHR'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkBool32 VKAPI_CALL Dummy_vkGetPhysicalDeviceWaylandPresentationSupportKHR (VkPhysicalDevice , uint32_t , struct wl_display * )			{  LOO_LOGI( "used dummy function 'vkGetPhysicalDeviceWaylandPresentationSupportKHR'" );  return VkBool32(0);  }
# endif // VULKAN_WAYLAND_H_
