	...
	namespace vkfg
	{
		...
		*/
		void SpirvCompiler::_GenerateResources (OUT TBuiltInResource& res)
		{
			...
			res.maxVertexAttribs = LOO_MaxVertexAttribs;
			...
			res.maxDrawBuffers = LOO_MaxColorBuffers;
			...
			res.maxViewports = LOO_MaxViewports;
		...
		*/
		bool SpirvCompiler::SetCurrentResourceLimits (PhysicalDeviceVk_t physicalDevice)
		{
			...
			res.maxVertexAttribs = loo::math::Min (LOO_MaxVertexAttribs, props.limits.maxVertexInputAttributes);
			res.maxDrawBuffers = loo::math::Min (LOO_MaxColorBuffers, props.limits.maxColorAttachments);
			...
			res.maxViewports = loo::math::Min (LOO_MaxViewports, props.limits.maxViewports);
