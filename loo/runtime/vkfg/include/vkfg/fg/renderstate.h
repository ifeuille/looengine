...
#include "vkfg/fg/renderstateenum.h"
...
{
	template <>
	struct hash< loo::RenderState::ColorBuffer > {
		ND_ size_t  operator () (const loo::RenderState::ColorBuffer &value) const;
	};

	template <>
	struct hash< loo::RenderState::ColorBuffersState > {
		ND_ size_t  operator () (const loo::RenderState::ColorBuffersState &value) const;
	};

	template <>
	struct hash< loo::RenderState::DepthBufferState > {
		ND_ size_t  operator () (const loo::RenderState::DepthBufferState &value) const;
	};

	template <>
	struct hash< loo::RenderState::StencilFaceState > {
		ND_ size_t  operator () (const loo::RenderState::StencilFaceState &value) const;
	};

	template <>
	struct hash< loo::RenderState::StencilBufferState > {
		ND_ size_t  operator () (const loo::RenderState::StencilBufferState &value) const;
	};

	template <>
	struct hash< loo::RenderState::InputAssemblyState > {
		ND_ size_t  operator () (const loo::RenderState::InputAssemblyState &value) const;
	};

	template <>
	struct hash< loo::RenderState::RasterizationState > {
		ND_ size_t  operator () (const loo::RenderState::RasterizationState &value) const;
	};

	template <>
	struct hash< loo::RenderState::MultisampleState > {
		ND_ size_t  operator () (const loo::RenderState::MultisampleState &value) const;
	};

	template <>
	struct hash< loo::RenderState > {
		ND_ size_t  operator () (const loo::RenderState &value) const;
	};
