...
namespace loo
{
	namespace vkfg
	{
		...
		class IFrameGraph : public std::enable_shared_from_this<IFrameGraph>
		{
			// types
		public:
			using DeviceInfo_t = nonstd::variant< NullUnion, VulkanDeviceInfo >;
			using SwapchainCreateInfo_t = nonstd::variant< NullUnion, VulkanSwapchainCreateInfo/*, VulkanVREmulatorSwapchainCreateInfo*/ >;
			using ExternalImageDesc_t = nonstd::variant< NullUnion, VulkanImageDesc >;
			using ExternalBufferDesc_t = nonstd::variant< NullUnion, VulkanBufferDesc >;
			using ExternalImage_t = nonstd::variant< NullUnion, ImageVk_t >;
			using ExternalBuffer_t = nonstd::variant< NullUnion, BufferVk_t >;
