...
namespace loo
{
	namespace vkfg
	{
		...
		*/
		...
		{
			return loo::math::Clamp (VkSampleCountFlagBits (value.Get ()), VK_SAMPLE_COUNT_1_BIT, VK_SAMPLE_COUNT_64_BIT);
		}
		...
		*/
		ND_ inline VkDynamicState  VEnumCast (EPipelineDynamicState value)
		{
			...
			case EPipelineDynamicState::_end:				break;	// to shutup warnings
			}
			END_ENUM_CHECKS ();
		...
		*/
		ND_ inline VkGeometryFlagsNV  VEnumCast (ERayTracingGeometryFlags values)
		{
			...
			for (ERayTracingGeometryFlags t = ERayTracingGeometryFlags (1); t <= values; t = ERayTracingGeometryFlags (uint (t) << 1))
			{
				...
				case ERayTracingGeometryFlags::_end:
		...
		*/
		ND_ inline VkGeometryInstanceFlagsNV   VEnumCast (ERayTracingInstanceFlags values)
		{
			...
			for (ERayTracingInstanceFlags t = ERayTracingInstanceFlags (1); t <= values; t = ERayTracingInstanceFlags (uint (t) << 1))
			{
				...
				case ERayTracingInstanceFlags::_end:
		...
		*/
		...
		/*
		=================================================
			LOO_PRIVATE_VKPIXELFORMATS
		=================================================
		*/
#	define LOO_PRIVATE_VKPIXELFORMATS( _builder_ ) \
...
#		define FMT_BUILDER( _engineFmt_, _vkFormat_ ) \
			...
			switch (value)
			{
				LOO_PRIVATE_VKPIXELFORMATS (FMT_BUILDER)
