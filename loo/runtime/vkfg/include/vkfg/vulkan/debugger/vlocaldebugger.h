...
namespace loo
{
	namespace vkfg
	{
		...
		{
			friend _GetResourceUsage_VisitFunc;
			// types
		private:
			...
			using ResourceUsage_t = nonstd::variant< NullUnion, ImageUsage_t, BufferUsage_t, RTSceneUsage_t, RTGeometryUsage_t >;
		...
		private:
			...
			ND_ String  _TaskLabelColor (loo::math::RGBA8u) const;
