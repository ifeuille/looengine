...
namespace loo
{
	...
	namespace vkfg
	{
		...
		public:
			...
			ND_ ArrayView<VertexAttrib>	GetVertexAttribs ()		const { SHAREDLOCK (RWDataRaceCheck, _drCheck);  return _vertexAttribs; }

			ND_ bool					IsEarlyFragmentTests ()	const { SHAREDLOCK (RWDataRaceCheck, _drCheck);  return _earlyFragmentTests; }
