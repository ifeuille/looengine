...
#include "vkfg/vulkan/commandbuffer/vtaskprocessor.h"
...
#include "vkfg/vulkan/utils/fgenumcast.h"
...
namespace loo
{
	namespace vkfg
	{
		...
		private:
			...
			using FragOutputs_t = StaticArray< FragmentOutput, LOO_MaxColorBuffers >;
		...
		public:
			...
			void Visit (const VFgDrawTask<loo::vkfg::DrawVertices> &task);
			void Visit (const VFgDrawTask<loo::vkfg::DrawIndexed> &task);
			void Visit (const VFgDrawTask<loo::vkfg::DrawMeshes> &task);
			void Visit (const VFgDrawTask<loo::vkfg::DrawVerticesIndirect> &task);
			void Visit (const VFgDrawTask<loo::vkfg::DrawIndexedIndirect> &task);
			void Visit (const VFgDrawTask<loo::vkfg::DrawMeshesIndirect> &task);
			void Visit (const VFgDrawTask<loo::vkfg::CustomDraw> &task);

			template <typename PipelineType>
			void _MergePipeline (const _vkfg_hidden_::DynamicStates &, const PipelineType *);
			...
			private:
				...
				private:
					...
					public:
						...
						void SetBlendColor (const loo::math::RGBA32f &value) override;
		...
		*/
		void VTaskProcessor::PipelineResourceBarriers::operator () (const UniformID &, const PipelineResources::RayTracingScene &rts)
		{
			for (uint i = 0; i < rts.elementCount; ++i)
			{
				...
				SHAREDLOCK (std::shared_mutex,data.guard);
		...
		*/
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskBarriers::Visit (const VFgDrawTask<loo::vkfg::DrawVertices> &task)
		{
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskBarriers::Visit (const VFgDrawTask<loo::vkfg::DrawIndexed> &task)
		{
			// update descriptor sets and add pipeline barriers
			_ExtractDescriptorSets (task.pipeline->GetLayoutID (), task);
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskBarriers::Visit (const VFgDrawTask<loo::vkfg::DrawVerticesIndirect> &task)
		{
			// update descriptor sets and add pipeline barriers
			_ExtractDescriptorSets (task.pipeline->GetLayoutID (), task);
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskBarriers::Visit (const VFgDrawTask<loo::vkfg::DrawIndexedIndirect> &task)
		{
			// update descriptor sets and add pipeline barriers
			_ExtractDescriptorSets (task.pipeline->GetLayoutID (), task);
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskBarriers::Visit (const VFgDrawTask<loo::vkfg::DrawMeshes> &task)
		{
			// update descriptor sets and add pipeline barriers
			_ExtractDescriptorSets (task.pipeline->GetLayoutID (), task);
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskBarriers::Visit (const VFgDrawTask<loo::vkfg::DrawMeshesIndirect> &task)
		{
			// update descriptor sets and add pipeline barriers
			_ExtractDescriptorSets (task.pipeline->GetLayoutID (), task);
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskBarriers::Visit (const VFgDrawTask<loo::vkfg::CustomDraw> &task)
		{
		...
		*/
		template <typename PipelineType>
		void VTaskProcessor::DrawTaskBarriers::_MergePipeline (const _vkfg_hidden_::DynamicStates &ds, const PipelineType* pipeline)
		{
		...
		*/
		void VTaskProcessor::DrawTaskCommands::_BindVertexBuffers (ArrayView<VLocalBuffer const*> vertexBuffers, ArrayView<VkDeviceSize> vertexOffsets) const
		{
			...
			FixedArray<VkBuffer, LOO_MaxVertexBuffers>	buffers;	buffers.resize (vertexBuffers.size ());
		...
		*/
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskCommands::Visit (const VFgDrawTask<loo::vkfg::DrawVertices> &task)
		{
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskCommands::Visit (const VFgDrawTask<loo::vkfg::DrawIndexed> &task)
		{
			//_tp._CmdDebugMarker( task.GetName() );
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskCommands::Visit (const VFgDrawTask<loo::vkfg::DrawVerticesIndirect> &task)
		{
			//_tp._CmdDebugMarker( task.GetName() );
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskCommands::Visit (const VFgDrawTask<loo::vkfg::DrawIndexedIndirect> &task)
		{
			//_tp._CmdDebugMarker( task.GetName() );
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskCommands::Visit (const VFgDrawTask<loo::vkfg::DrawMeshes> &task)
		{
			//_tp._CmdDebugMarker( task.GetName() );
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskCommands::Visit (const VFgDrawTask<loo::vkfg::DrawMeshesIndirect> &task)
		{
			//_tp._CmdDebugMarker( task.GetName() );
		...
		=================================================
		*/
		inline void VTaskProcessor::DrawTaskCommands::Visit (const VFgDrawTask<loo::vkfg::CustomDraw> &task)
		{
		...
		*/
		...
		=================================================
		*/
		void VTaskProcessor::DrawContext::SetBlendColor (const loo::math::RGBA32f &value)
		{
		...
		*/
		void VTaskProcessor::DrawContext::SetShadingRatePalette (uint viewportIndex, ArrayView<EShadingRatePalette> value)
		{
			...
			palette.shadingRatePaletteEntryCount = loo::math::Max (1u, uint (value.size ()));
		...
		*/
		...
		{
			static_cast<DrawTaskBarriers *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::DrawVertices>*>(taskData));
		}

		void VTaskProcessor::Visit2_DrawVertices (void *visitor, void *taskData)
		{
			static_cast<DrawTaskCommands *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::DrawVertices>*>(taskData));
		}
		...
		*/
		...
		{
			static_cast<DrawTaskBarriers *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::DrawIndexed>*>(taskData));
		}

		void VTaskProcessor::Visit2_DrawIndexed (void *visitor, void *taskData)
		{
			static_cast<DrawTaskCommands *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::DrawIndexed>*>(taskData));
		}
		...
		*/
		...
		{
			static_cast<DrawTaskBarriers *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::DrawMeshes>*>(taskData));
		}

		void VTaskProcessor::Visit2_DrawMeshes (void *visitor, void *taskData)
		{
			static_cast<DrawTaskCommands *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::DrawMeshes>*>(taskData));
		}
		...
		*/
		...
		{
			static_cast<DrawTaskBarriers *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::DrawVerticesIndirect>*>(taskData));
		}

		void VTaskProcessor::Visit2_DrawVerticesIndirect (void *visitor, void *taskData)
		{
			static_cast<DrawTaskCommands *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::DrawVerticesIndirect>*>(taskData));
		}
		...
		*/
		...
		{
			static_cast<DrawTaskBarriers *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::DrawIndexedIndirect>*>(taskData));
		}

		void VTaskProcessor::Visit2_DrawIndexedIndirect (void *visitor, void *taskData)
		{
			static_cast<DrawTaskCommands *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::DrawIndexedIndirect>*>(taskData));
		}
		...
		*/
		...
		{
			static_cast<DrawTaskBarriers *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::DrawMeshesIndirect>*>(taskData));
		}

		void VTaskProcessor::Visit2_DrawMeshesIndirect (void *visitor, void *taskData)
		{
			static_cast<DrawTaskCommands *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::DrawMeshesIndirect>*>(taskData));
		}
		...
		*/
		...
		{
			static_cast<DrawTaskBarriers *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::CustomDraw>*>(taskData));
		}

		void VTaskProcessor::Visit2_CustomDraw (void *visitor, void *taskData)
		{
			static_cast<DrawTaskCommands *>(visitor)->Visit (*static_cast<VFgDrawTask<loo::vkfg::CustomDraw>*>(taskData));
		}
		...
		*/
		...
		=================================================
		*/
		void VTaskProcessor::_SetScissor (const VLogicalRenderPass &logicalPsss, ArrayView<loo::math::RectI> srcScissors)
		{
			if (not srcScissors.empty ())
			{
				FixedArray< VkRect2D, LOO_MaxViewports >		vk_scissors;
		...
		=================================================
		*/
		void VTaskProcessor::_SetDynamicStates (const _vkfg_hidden_::DynamicStates &state) const
		{
		...
		*/
		...
		{
			using Attachment_t = FixedArray< Pair<RawImageID, ImageViewDesc>, LOO_MaxColorBuffers + 1 >;
			...
			Optional<loo::math::RectI>		total_area;
			...
			RawFramebufferID	fb_id = _fgThread.GetResourceManager ().CreateFramebuffer (render_targets, rp_id, loo::math::uint2 (total_area->Size ()), 1, "");
			CHECK_ERR (fb_id);
		...
		*/
		void VTaskProcessor::_BeginRenderPass (const VFgTask<SubmitRenderPass> &task)
		{
			...
			loo::math::RectI const&		area = task.GetLogicalPass ()->GetArea ();
		...
		*/
		...
		{
			const FixedArray< uint, LOO_MaxBufferDynamicOffsets >	old_offsets = resourceSet.dynamicOffsets;
			StaticArray< Pair<uint, uint>, LOO_MaxDescriptorSets >	new_offsets = {};
		...
		*/
		...
		=================================================
		*/
		void VTaskProcessor::_PushConstants (const VPipelineLayout &layout, const _vkfg_hidden_::PushConstants_t &pushConstants) const
		{
		...
		*/
		inline void VTaskProcessor::_BindPipeline2 (const VLogicalRenderPass &logicalRP, VkPipeline pipelineId)
		{
			...
			auto viewports = logicalRP.GetViewports ();
			if (viewports.size ())
				vkCmdSetViewport (_cmdBuffer, 0, uint (viewports.size ()), viewports.data ());
			auto palette = logicalRP.GetShadingRatePalette ();
			if (palette.size ())
		...
		=================================================
		*/
		static void OverrideColorStates (INOUT RenderState::ColorBuffersState &currColorStates, const _vkfg_hidden_::ColorBuffers_t &newStates)
		{
		...
		*/
		static void OverrideDepthStencilStates (INOUT RenderState::DepthBufferState &currDepthState, INOUT RenderState::StencilBufferState &currStencilState,
			...
			const _vkfg_hidden_::DynamicStates &newStates)
		{
		...
		*/
		...
		=================================================
		*/
		inline void VTaskProcessor::_BindPipeline (const VComputePipeline* pipeline, const Optional<loo::math::uint3> &localSize,
		...
		void VTaskProcessor::Visit (const VFgTask<CopyBuffer> &task)
		{
			...
			for (size_t i = 0, count = regions.size (); i < count; ++i)
			{
				...
				if (src_buffer == dst_buffer) {
					ASSERT (loo::math::IsIntersects (dst.srcOffset, dst.size == VK_WHOLE_SIZE ? dst.size : dst.srcOffset + dst.size,
		...
		*/
		void VTaskProcessor::Visit (const VFgTask<CopyImage> &task)
		{
			...
			for (size_t i = 0, count = regions.size (); i < count; ++i)
			{
				const auto&		src = task.regions[i];
				auto&			dst = regions[i];
				const loo::math::uint3		image_size = Max (src.size, 1u);
		...
		*/
		void VTaskProcessor::Visit (const VFgTask<CopyBufferToImage> &task)
		{
			...
			for (size_t i = 0, count = regions.size (); i < count; ++i)
			{
				const auto&			src = task.regions[i];
				auto&				dst = regions[i];
				const loo::math::int3			img_offset = loo::math::int3 (src.imageOffset);
				const loo::math::uint3			img_size = loo::math::Max (src.imageSize, 1u);
		...
		*/
		void VTaskProcessor::Visit (const VFgTask<CopyImageToBuffer> &task)
		{
			...
			for (size_t i = 0, count = regions.size (); i < count; ++i)
			{
				const auto&			src = task.regions[i];
				auto&				dst = regions[i];
				const loo::math::uint3			image_size = Max (src.imageSize, 1u);
		...
		*/
		void VTaskProcessor::Visit (const VFgTask<ResolveImage> &task)
		{
			...
			for (size_t i = 0, count = regions.size (); i < count; ++i)
			{
				const auto&			src = task.regions[i];
				auto&				dst = regions[i];
				const loo::math::uint3			image_size = Max (src.extent, 1u);
		...
		*/
		void VTaskProcessor::Visit (const VFgTask<GenerateMipmaps> &task)
		{
			...
			const uint				level_count = loo::math::Min (task.levelCount, image->MipmapLevels () - loo::math::Min (image->MipmapLevels () - 1, task.baseLevel));
			const uint				arr_layers = image->ArrayLayers ();
			const loo::math::uint3				dimension = image->Dimension () >> task.baseLevel;
			...
			{
				const loo::math::int3	src_size = Max (1u, dimension >> (i - 1));
				const loo::math::int3	dst_size = Max (1u, dimension >> i);
		...
		*/
		void VTaskProcessor::Visit (const VFgTask<Present> &task)
		{
			...
			const loo::math::uint3				src_dim = src_image->Dimension ();
			const loo::math::uint3				dst_dim = dst_image->Dimension ();
		...
		*/
		inline void VTaskProcessor::_AddBuffer (const VLocalBuffer *buf, EResourceState state, VkDeviceSize offset, VkDeviceSize size)
		{
			...
			size = loo::math::Min (buf_size, (size == VK_WHOLE_SIZE ? buf_size - offset : offset + size));
		...
		*/
			...
			const VkBufferImageCopy &reg, const VLocalImage *img)
		{
			...
			const uint			dim_z = loo::math::Max (reg.imageSubresource.layerCount, reg.imageExtent.depth);
