...
the XML needs to be consistent with the Vulkan headers that live in ifvk/include/vulkan.
...
TODO: To reduce globals and conditional branching, it would be nice if IfVK were to implement
...
def produceHeader(function_groups, enum_vals, flag_vals, output_dir):
    fullpath = os.path.join(output_dir, 'ifvk/IfVK.h')
...
def produceCpp(function_groups, enum_vals, flag_vals, output_dir):
    fullpath = os.path.join(output_dir, 'IfVK.cpp')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-I', '--include', help='Parent location for ifvk/IfVK.h')
    parser.add_argument('-o', '--output', help='Output directory for IfVK.cpp')
