...
bool ifvk::initialize() {
    if (!ifvk::loadLibrary()) {
        return false;
    }

    vkGetInstanceProcAddr = (PFN_vkGetInstanceProcAddr) ifvk::getInstanceProcAddr();
    loadLoaderFunctions(nullptr, vkGetInstanceProcAddrWrapper);
    return true;
}

void ifvk::bindInstance(VkInstance instance) {
    loadInstanceFunctions(instance, vkGetInstanceProcAddrWrapper);
    loadDeviceFunctions(instance, vkGetDeviceProcAddrWrapper);
}
...
utils::io::ostream& operator<<(utils::io::ostream& out, const VkDriverIdKHR& value) {
    switch (value) {
        case VK_DRIVER_ID_AMD_PROPRIETARY_KHR: out << "VK_DRIVER_ID_AMD_PROPRIETARY_KHR"; break;
        case VK_DRIVER_ID_AMD_OPEN_SOURCE_KHR: out << "VK_DRIVER_ID_AMD_OPEN_SOURCE_KHR"; break;
        case VK_DRIVER_ID_MESA_RADV_KHR: out << "VK_DRIVER_ID_MESA_RADV_KHR"; break;
        case VK_DRIVER_ID_NVIDIA_PROPRIETARY_KHR: out << "VK_DRIVER_ID_NVIDIA_PROPRIETARY_KHR"; break;
        case VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS_KHR: out << "VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS_KHR"; break;
        case VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA_KHR: out << "VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA_KHR"; break;
...
utils::io::ostream& operator<<(utils::io::ostream& out, const VkCopyAccelerationStructureModeNV& value) {
    switch (value) {
        case VK_COPY_ACCELERATION_STRUCTURE_MODE_CLONE_NV: out << "VK_COPY_ACCELERATION_STRUCTURE_MODE_CLONE_NV"; break;
        case VK_COPY_ACCELERATION_STRUCTURE_MODE_COMPACT_NV: out << "VK_COPY_ACCELERATION_STRUCTURE_MODE_COMPACT_NV"; break;
        default: out << "UNKNOWN"; break;
    }
    return out;
}
utils::io::ostream& operator<<(utils::io::ostream& out, const VkAccelerationStructureTypeNV& value) {
    switch (value) {
        case VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_NV: out << "VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_NV"; break;
        case VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_NV: out << "VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_NV"; break;
        default: out << "UNKNOWN"; break;
    }
    return out;
}
utils::io::ostream& operator<<(utils::io::ostream& out, const VkGeometryTypeNV& value) {
    switch (value) {
        case VK_GEOMETRY_TYPE_TRIANGLES_NV: out << "VK_GEOMETRY_TYPE_TRIANGLES_NV"; break;
        case VK_GEOMETRY_TYPE_AABBS_NV: out << "VK_GEOMETRY_TYPE_AABBS_NV"; break;
        default: out << "UNKNOWN"; break;
    }
    return out;
}
...
utils::io::ostream& operator<<(utils::io::ostream& out, const VkRayTracingShaderGroupTypeNV& value) {
    switch (value) {
        case VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_NV: out << "VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_NV"; break;
        case VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_NV: out << "VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_NV"; break;
        case VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_NV: out << "VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_NV"; break;
        default: out << "UNKNOWN"; break;
    }
    return out;
}
...
//utils::io::ostream& operator<<(utils::io::ostream& out, const VkFullScreenExclusiveEXT& value) {
//    switch (value) {
//        case VK_FULL_SCREEN_EXCLUSIVE_DEFAULT_EXT: out << "VK_FULL_SCREEN_EXCLUSIVE_DEFAULT_EXT"; break;
//        case VK_FULL_SCREEN_EXCLUSIVE_ALLOWED_EXT: out << "VK_FULL_SCREEN_EXCLUSIVE_ALLOWED_EXT"; break;
//        case VK_FULL_SCREEN_EXCLUSIVE_DISALLOWED_EXT: out << "VK_FULL_SCREEN_EXCLUSIVE_DISALLOWED_EXT"; break;
//        case VK_FULL_SCREEN_EXCLUSIVE_APPLICATION_CONTROLLED_EXT: out << "VK_FULL_SCREEN_EXCLUSIVE_APPLICATION_CONTROLLED_EXT"; break;
//        default: out << "UNKNOWN"; break;
//    }
//    return out;
//}
...
utils::io::ostream& operator<<(utils::io::ostream& out, const VkResolveModeFlagBitsKHR& value) {
    switch (value) {
        case 0x00000000: out << "VK_RESOLVE_MODE_NONE_KHR"; break;
        case 0x00000001: out << "VK_RESOLVE_MODE_SAMPLE_ZERO_BIT_KHR"; break;
        case 0x00000002: out << "VK_RESOLVE_MODE_AVERAGE_BIT_KHR"; break;
        case 0x00000004: out << "VK_RESOLVE_MODE_MIN_BIT_KHR"; break;
        case 0x00000008: out << "VK_RESOLVE_MODE_MAX_BIT_KHR"; break;
        default: out << "UNKNOWN_FLAGS"; break;
    }
    return out;
}
utils::io::ostream& operator<<(utils::io::ostream& out, const VkGeometryInstanceFlagBitsNV& value) {
    switch (value) {
        case 0x00000001: out << "VK_GEOMETRY_INSTANCE_TRIANGLE_CULL_DISABLE_BIT_NV"; break;
        case 0x00000002: out << "VK_GEOMETRY_INSTANCE_TRIANGLE_FRONT_COUNTERCLOCKWISE_BIT_NV"; break;
        case 0x00000004: out << "VK_GEOMETRY_INSTANCE_FORCE_OPAQUE_BIT_NV"; break;
        case 0x00000008: out << "VK_GEOMETRY_INSTANCE_FORCE_NO_OPAQUE_BIT_NV"; break;
        default: out << "UNKNOWN_FLAGS"; break;
    }
    return out;
}
utils::io::ostream& operator<<(utils::io::ostream& out, const VkGeometryFlagBitsNV& value) {
    switch (value) {
        case 0x00000001: out << "VK_GEOMETRY_OPAQUE_BIT_NV"; break;
        case 0x00000002: out << "VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT_NV"; break;
        default: out << "UNKNOWN_FLAGS"; break;
    }
    return out;
}
utils::io::ostream& operator<<(utils::io::ostream& out, const VkBuildAccelerationStructureFlagBitsNV& value) {
    switch (value) {
        case 0x00000001: out << "VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_NV"; break;
        case 0x00000002: out << "VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_BIT_NV"; break;
        case 0x00000004: out << "VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_NV"; break;
        case 0x00000008: out << "VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_BUILD_BIT_NV"; break;
        case 0x00000010: out << "VK_BUILD_ACCELERATION_STRUCTURE_LOW_MEMORY_BIT_NV"; break;
        default: out << "UNKNOWN_FLAGS"; break;
    }
    return out;
}
...
#define VK1_CASE_ERR( _code_ ) \
		...
		default:	msg = msg + "unknown (" + std::to_string (int (errCode)) + ')';  break;
		}
		END_ENUM_CHECKS ();
#undef VK1_CASE_ERR
