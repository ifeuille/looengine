...
#define LOO_PREPEND_NAMESPACE(name) ::name
...
*/
	//template <int> struct LooIntegerForSize;
	//template <>    struct LooIntegerForSize<1> { typedef luint8  Unsigned; typedef lint8  Signed; };
	//template <>    struct LooIntegerForSize<2> { typedef luint16 Unsigned; typedef lint16 Signed; };
	//template <>    struct LooIntegerForSize<4> { typedef luint32 Unsigned; typedef lint32 Signed; };
	//template <>    struct LooIntegerForSize<8> { typedef luint64 Unsigned; typedef lint64 Signed; };
	//template <class T> struct LooIntegerForSizeof : LooIntegerForSize<sizeof (T)> { };
	//typedef LooIntegerForSize<LOO_PROCESSOR_WORDSIZE>::Signed looregisterint;
	//typedef LooIntegerForSize<LOO_PROCESSOR_WORDSIZE>::Unsigned looregisteruint;
	//typedef LooIntegerForSizeof<void*>::Unsigned luintptr;
	//typedef LooIntegerForSizeof<void*>::Signed lptrdiff;
	//typedef lptrdiff lintptr;
...
#  else
#    define LOO_ASSERT(cond) ((!(cond)) ? assert(false)/*(#cond,__FILE__,__LINE__) */: loo_noop())
#  endif
#endif
...
#  else
#    define LOO_ASSERT_X(cond, where, what) ((!(cond)) ? assert(false)/*assert(where, what,__FILE__,__LINE__)*/ : loo_noop())
#  endif
#endif
