	...
	namespace LooPrivate
	{
		...
		*/
		...
		/*
			...
			std::underlying_type on non-enums (cf. ¡ì20.13.7.6 [meta.trans.other]).
		*/
		...
		/*
		   ...
		   argument of the signal when used in list initialization. Cf. ¡ì8.5.4.7
...
#ifdef LOO_NO_NARROWING_CONVERSIONS_IN_CONNECT
